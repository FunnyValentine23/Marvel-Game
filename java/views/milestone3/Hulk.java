...
public class Hulk extends GridPane implements Hazem {
    ImageView imageView;
    String name = "Hulk";
    int count = 9;
    int columns = 7;
    ...
    public Hulk(ImageView imageView){
    ...
    public void attack(){
        try {
            ...
            p.setAutoPlay(true);
            p.play();
            animation.setColumn(5);
            animation.setCount(5);
            animation.setWidth(60);
            animation.setHeight(72);
            animation.setOffsetX(0);
            animation.setOffsetY(387);
            animation.play();
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/Rage.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
            ...
            animation.setWidth(56);
            animation.setHeight(65);
            animation.setOffsetX(0);
            animation.setOffsetY(240);
            animation.play();
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/HulkSmash.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
            animation.setColumn(5);
            animation.setCount(5);
            animation.setWidth(65);
            animation.setHeight(80);
            animation.setOffsetX(15);
    ...
    public void R() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/SunIsGettingRealLow.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
            ...
            animation.setHeight(75);
            animation.setOffsetX(0);
            animation.setOffsetY(75);
            animation.play();
        } catch (AbilityUseException e) {
            GameScene.showFlashMessage("Cannot Use Ability");
        } catch (InvalidTargetException e) {
