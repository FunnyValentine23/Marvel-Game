...
public class Deadpool extends GridPane implements Hazem {
    ImageView imageView;
    ...
    public Deadpool(ImageView imageView){
...
//        animation.setWidth(35);
//        animation.setHeight(55);
//        animation.setOffsetX(0);
//        animation.setOffsetY(202);
//        animation.play();
        moveX(-100);
    }
...
//            animation.play();
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/TryHarder.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/8BulletsLeft.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void R(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/CantCatchMe.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
