...
public class GhostRider extends GridPane implements Hazem {
    ImageView imageView;
    String name = "Ghost Rider";
    int count = 6;
    int columns = 6;
    int offsetX = 0;
    int offsetY = 0;
    ...
    public GhostRider(ImageView imageView){
...
//            animation.play();
    ...
    public void Q() {
        ...
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/DeathStare.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/FireBreath.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void R(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/ChainWhip.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
