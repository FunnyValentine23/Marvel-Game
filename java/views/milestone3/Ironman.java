...
public class Ironman extends GridPane implements Hazem{
    ImageView imageView;
    String name = "Ironman";
    int count = 5;
    int columns = 4;
    ...
    public Ironman(ImageView imageView){
    ...
    public void moveLEFT(){
        ...
        animation.setColumn(4);
        animation.setWidth(85);
        animation.setHeight(100);
        animation.setOffsetX(225);
        animation.setOffsetY(185);
        animation.play();
        moveX(-100);
    }
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/IamIronman.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
            ...
            animation.setWidth(85);
            animation.setHeight(100);
            animation.setOffsetX(548);
            animation.setOffsetY(1203);
            animation.play();
    ...
    public void E(){
        try {
            ...
            Controller.g.castAbility(Controller.g.getCurrentChampion().getAbilities().get(1), d);
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/Unibeam.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
            ...
            animation.setWidth(100);
            animation.setHeight(100);
            animation.setOffsetX(315);
            animation.setOffsetY(1045);
            animation.play();
        } catch (CloneNotSupportedException e) {
    ...
    public void R() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/3000.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
