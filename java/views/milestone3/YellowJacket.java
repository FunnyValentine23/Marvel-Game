...
public class YellowJacket extends GridPane implements Hazem {
    ImageView imageView;
    String name = "Yellow Jacket";
    int count = 6;
    int columns = 6;
    int offsetX = 0;
    int offsetY = 0;
    ...
    public YellowJacket(ImageView imageView){
...
//            animation.play();
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/LaserSting.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/Quantamania.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void R(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/PymParticleUpsize.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
