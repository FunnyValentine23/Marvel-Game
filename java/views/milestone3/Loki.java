...
public class Loki extends GridPane implements Hazem {
    ImageView imageView;
    String name = "Loki";
    int count = 6;
    int columns = 6;
    ...
    public Loki(ImageView imageView){
...
//            animation.play();
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/GodOfMischief.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void E(){
        ...
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/TheHiddenDagger.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void R() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/FakeDeath.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
