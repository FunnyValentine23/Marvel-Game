...
public class Quicksilver extends GridPane implements Hazem{
    ImageView imageView;
    ...
    public Quicksilver(ImageView imageView){
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/TimeInABottle.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
    ...
    public void E() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/GoodAsNew.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
    ...
    public void R(){
        ...
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/1sec100punch.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
