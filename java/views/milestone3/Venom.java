...
public class Venom extends GridPane implements Hazem{
    ImageView imageView;
    String name = "Venom";
    int count = 6;
    int columns = 6;
    ...
    public Venom(ImageView imageView){
    ...
    public void moveLEFT(){
        ...
        animation.setWidth(53);
        animation.setHeight(88);
        animation.setOffsetX(10);
        animation.setOffsetY(100);
        animation.play();
        moveX(-100);
    }
    ...
    public void attack(){
        try {
            ...
            animation.setWidth(58);
            animation.setHeight(79);
            animation.setOffsetX(0);
            animation.setOffsetY(711);
            animation.play();
    ...
    public void Q() {
            ...
            try {
                try {
                    ...
                    Media m = new Media(Objects.requireNonNull(getClass().getResource("/HeadBite.mp3")).toURI().toString());
                    p = new MediaPlayer(m);
                    p.setCycleCount(1);
                    p.setAutoPlay(true);
                    p.play();
                    ...
                    animation.setWidth(78);
                    animation.setHeight(88);
                    animation.setOffsetX(20);
                    animation.setOffsetY(601);
                    animation.play();
                } catch (AbilityUseException ex) {
                    GameScene.showFlashMessage("Cannot Cast Abiltiy");
                } catch (InvalidTargetException ex) {
                    GameScene.showFlashMessage("Invalid Target");
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/WeAreVenom.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
            ...
            animation.setWidth(60);
            animation.setHeight(91);
            animation.setOffsetX(270);
            animation.setOffsetY(711);
            animation.play();
            ...
            GameScene.showFlashMessage("Not Enough Action Points");
        } catch (CloneNotSupportedException | URISyntaxException e) {
            e.printStackTrace();
        }
    }
    ...
    public void R() {
        displaySingle();
        try {
            Controller.g.castAbility(Controller.g.getCurrentChampion().getAbilities().get(2), y, x);
            e = false;
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/Symbiosis.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
            ...
            animation.setWidth(80);
            animation.setHeight(80);
            animation.setOffsetX(0);
            animation.setOffsetY(310);
            animation.play();
        } catch (AbilityUseException ex) {
            GameScene.showFlashMessage("Cannot Use Ability");
        } catch (InvalidTargetException ex) {
