...
public class Spiderman extends GridPane implements Hazem{
    ImageView imageView;
    ...
    public Spiderman(ImageView imageView){
...
//            animation.play();
    ...
    public void Q() {
        ...
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/GiveMeThat.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void E() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/WebTrap.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void R() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/Spiderverse.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
