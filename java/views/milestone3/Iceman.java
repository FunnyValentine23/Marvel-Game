...
public class Iceman extends GridPane implements Hazem{
    ImageView imageView;
    String name = "Iceman";
    int count = 6;
    int columns = 6;
    ...
    public Iceman(ImageView imageView){
...
//            animation.play();
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/FrostBite.wav")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/Subzero.wav")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void R() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/Hailstorm.wav")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
