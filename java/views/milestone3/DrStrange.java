...
public class DrStrange extends GridPane implements Hazem{
    ImageView imageView;
    ...
    public DrStrange(ImageView imageView){
...
//            animation.play();
    ...
    public void Q() {
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/TheEyeOfAgamotto.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/ThousandHand.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
...
//            animation.play();
    ...
    public void R(){
        ...
        try {
            ...
            Media m = null;
            try {
                m = new Media(Objects.requireNonNull(getClass().getResource("/MirrorDimension.mp3")).toURI().toString());
