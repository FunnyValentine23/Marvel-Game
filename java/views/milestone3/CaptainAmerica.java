...
public class CaptainAmerica extends GridPane implements Hazem {
    ImageView imageView;
    ...
    public CaptainAmerica(ImageView imageView){
    ...
    public void Q() {
        try {
            ...
            Controller.g.castAbility(Controller.g.getCurrentChampion().getAbilities().get(0), d);
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/ShieldThrow.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
    ...
    public void E(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/I Can Do This All Day.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
    ...
    public void R(){
        try {
            ...
            Media m = new Media(Objects.requireNonNull(getClass().getResource("/ShieldUp.mp3")).toURI().toString());
            p = new MediaPlayer(m);
            p.setCycleCount(1);
            p.setAutoPlay(true);
            p.play();
